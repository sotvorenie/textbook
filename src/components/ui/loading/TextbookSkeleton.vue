...
<template>
  ...
  <div class="skeleton skeleton-default-item">
    <div class="skeleton-default-item__title line line__background h-30"></div>
    <div class="skeleton-default-item__slider flex">
      <div class="line__background" v-for="_ in 3"></div>
    </div>
